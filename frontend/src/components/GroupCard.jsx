      ...
      <div className="bg-[#dddddd] border flex flex-col justify-between border-[#333333] h-full rounded-lg text-center w-75 pb-5 shadow-2xl text-[#333333]">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-center mt-2 space-x-5">
            <div className="flex justify-center items-center"><FontAwesomeIcon className="mr-1 text-[#F5C469]" icon={faBox}/><p>{TotalProducts} Products</p></div>
            <div className="flex justify-center items-center"><FontAwesomeIcon className="mr-1 text-[#F5C469]" icon={faUser}/><p>{TotalGroupMembers} Members</p></div>
          </div>
        </div>
        <div className="mt-4">
